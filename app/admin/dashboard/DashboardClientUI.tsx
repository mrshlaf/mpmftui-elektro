  ...
  return (
    <div className="space-y-10">
      ...
      <motion.div
        ...
        className="relative overflow-hidden p-12 rounded-[3.5rem] bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800 shadow-2xl shadow-slate-200/50 dark:shadow-none"
      >
        ...
        <div className="absolute top-0 right-0 w-96 h-full bg-slate-50 dark:bg-slate-800 opacity-50 pointer-events-none" />
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        {stats.map((stat, idx) => {
          ...
          return (
            ...
            >
              <Card className="rounded-[2.5rem] border-slate-100 dark:border-slate-800 shadow-[0_10px_40px_rgba(0,0,0,0.02)] dark:shadow-none hover:shadow-[0_20px_50px_rgba(0,0,0,0.05)] transition-all group overflow-hidden bg-white dark:bg-slate-900">
                <CardContent className="p-8">
                  <div className="flex items-center justify-between mb-8">
                    <div className={`w-14 h-14 ${stat.bg} ${stat.color} rounded-2xl flex items-center justify-center transition-transform group-hover:scale-110 shadow-sm border border-slate-50 dark:border-slate-800`}>
                      <Icon className="w-6 h-6" />
                    </div>
                    <div className="flex items-center text-[10px] font-black tracking-widest text-slate-500 dark:text-slate-400">
        ...
        {blocks.map((block) => {
          ...
          return (
            <motion.div
              ...
              className="p-10 rounded-[3rem] bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800 shadow-[0_10px_40px_rgba(0,0,0,0.02)] dark:shadow-none"
            >
              <div className="flex items-center justify-between mb-10">
                <div className="flex items-center space-x-3">
                  ...
                  <h3 className="font-black text-slate-900 dark:text-white uppercase tracking-tighter text-lg">{block.title}</h3>
                </div>
              ...
              <div className="py-12 flex flex-col items-center justify-center space-y-4 border-2 border-dashed border-slate-50 dark:border-slate-800/50 rounded-[2rem]">
